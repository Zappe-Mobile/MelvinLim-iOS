...
-(void)setController:(BOOL)value
{
        ...
        viewController.bounceOnSidePanelOpen = NO;
        viewController.bounceOnCenterPanelChange = NO;
        
        SideMenuViewController * objSidePanel = [[SideMenuViewController alloc]init];
        viewController.leftPanel = objSidePanel;
        ...
        [[UINavigationBar appearance] setBarTintColor:[UIColor colorWithRed:174.0f/255.0f green:175.0f/255.0f blue:0.0f/255.0f alpha:1.0]];

    
        viewController.centerPanel = chariotNav;
